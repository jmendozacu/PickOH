...
abstract class Magecheckout_Facebook_BaseFacebook
{
    ...
    protected function getAccessTokenFromCode($code)
    {
        ...
        //parse_str(json_decode($access_token_response), $response_params);
        $json_decode_access_token_response = json_decode($access_token_response);
        //echo '<pre>'; print_r($json_decode_access_token_response->access_token); die;
        if (!isset($json_decode_access_token_response->access_token)) {
            return false;
        }

        return $json_decode_access_token_response->access_token;
    }
