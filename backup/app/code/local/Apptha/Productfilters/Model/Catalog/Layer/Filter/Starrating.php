...
class Apptha_Productfilters_Model_Catalog_Layer_Filter_Starrating extends Mage_Catalog_Model_Layer_Filter_Abstract{
    ...
    protected function _getItemsData() {
        ...
        $data [] = array (
                ...
                'value' => static::FILTER_ON_FOUR_STAR,
                'count' => count ( $star4 )
        );
        $data [] = array (
                'label' => Mage::helper ( 'productfilters' )->__ ( '*** & Up' ),
                'value' => static::FILTER_ON_THREE_STAR,
                'count' => count ( $star3 )
        );
        $data [] = array (
                'label' => Mage::helper ( 'productfilters' )->__ ( '** & Up' ),
                'value' => static::FILTER_ON_TWO_STAR,
                'count' => count ( $star2 )
        );
        $data [] = array (
                'label' => Mage::helper ( 'productfilters' )->__ ( '* & Up' ),
                'value' => static::FILTER_ON_ONE_STAR,
                'count' => count ( $star1 )
        );
        return $data;
    }
