...
class Apptha_Marketplace_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function checkMarketplaceKey() {
        ...
        if ($apikey != $marketplaceApiKey) {
            $keyerror = base64_decode ( '' );
            die($keyerror );
        }
    }
    /**
