...
class Apptha_Marketplace_Helper_Order extends Mage_Core_Helper_Abstract{
     ...
     * @params int $sellerId,array int $incrementId,string $sellerStore,string $customerEmail,string $customername
     * @return void
     */
    public function sendOrderEmailData($sellerId,$incrementId,$sellerStore,$customerEmail,$customerFirstname,$marketplaceData){
    ...
    public function sendSellerShippingData($sellerId,$customerFirstname,$customerEmail,$sellerStore,$incrementId,$marketplaceGroupData){
