...
class Apptha_Marketplace_Block_Order_Manage extends Mage_Core_Block_Template {
    ...
    public function getSellerShippingDetails($getOrderId, $getSellerId) {
        ...
        return count($productNames);
    }
    /**
     *
     * Function to get weekdays
     * @param unknown $to_day
     * @return number[]
     */
    public function getWeekDay($to_day){
        if ($to_day == 'Monday') {
     ...
     * @return object
     */
    public function getCurrencyRates($baseCurrencyCode,$orderCurrencyCode){
        return Mage::getModel('directory/currency')->getCurrencyRates($baseCurrencyCode, array($orderCurrencyCode));
    }
     ...
     * @return object
     */
    public function getSellerProfileData($sellerId){
     ...
     * @return object
     */
    public function getSalesOrderData($getOrderId){
        return Mage::getModel('sales/order')->load($getOrderId);
    }
}