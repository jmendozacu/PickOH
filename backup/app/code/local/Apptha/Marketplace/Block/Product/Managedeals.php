...
class Apptha_Marketplace_Block_Product_Managedeals extends Mage_Core_Block_Template {
     ...
     * @return void
     */
    public function  checkIncrement($incrementCat,$count){
    ...
    public function categoryCollection(){
        return  Mage::getModel('catalog/category')->getCollection()->addAttributeToSelect('category_id');
    }
     ...
     *
     */
    public function categoryModelObject($categoryIds){
        return  Mage::getModel('catalog/category')->load($categoryIds);
    }
     ...
     *
     */
    public function getProductQty($prodId){
        return  Mage::getModel('cataloginventory/stock_item')->loadByProduct ( $prodId )->getQty ();
    }
     ...
     *
     */
    public function getProductIsInStock($prodId){
         return Mage::getModel('cataloginventory/stock_item')->loadByProduct($prodId)->getIsInStock ();
    }
}