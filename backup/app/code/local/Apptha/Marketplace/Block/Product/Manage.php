...
class Apptha_Marketplace_Block_Product_Manage extends Mage_Core_Block_Template {
     ...
     * @return void
     */
    public function checkProductIncrement($incrementCat, $count) {
   ...
   /**
    ...
    public function getProductQty($productId){
        $productObject=Mage::getModel ( 'cataloginventory/stock_item' )->loadByProduct ( $productId );
        return  $productObject->getQty ();
    }
   ...
   /**
     ...
     *
     */
    public function categoryModelObject($_categoryIds){
        return  Mage::getModel('catalog/category')->load($_categoryIds);
    }
}