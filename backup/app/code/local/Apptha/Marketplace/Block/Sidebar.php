...
class Apptha_Marketplace_Block_Sidebar extends Mage_Core_Block_Template {
    ...
    protected $componentCss = 'css/bannerslider/component.css';
    protected $demoCss = 'css/bannerslider/demo.css';
    protected $normalizeCss = 'css/bannerslider/normalize.css';
    /**
    ...
    protected function _prepareLayout() {
        ...
        if (($headBlock = $this->getLayout ()->getBlock ( 'head' )) !== false) {
            ...
            $headBlock->addCss ( $this->componentCss );
            $headBlock->addCss ( $this->demoCss );
            $headBlock->addCss ( $this->normalizeCss);
        }
