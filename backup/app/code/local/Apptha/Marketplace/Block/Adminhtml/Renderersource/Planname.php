...
class Apptha_Marketplace_Block_Adminhtml_Renderersource_Planname extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
 ...
 public function render(Varien_Object $row) {
        ...
        if (! empty ( $upgragePlan ['upgrade_to'] )) {
            $collectionObject = Mage::getModel ( 'marketplace/subscriptionplans' )->getCollection ()->addFieldToFilter ( 'plan_id', $upgragePlan ['upgrade_to'] );
            $collectionFeature=$collectionObject->getData();
